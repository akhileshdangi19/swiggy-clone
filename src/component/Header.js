      ...
      <div>
        <nav className="navbar navbar-expand-lg">
          <div className="container-fluid">
            <a href="/" className="logo" title="Swiggy">
              <svg
                className="logoo"
                viewBox="0 0 559 825"
                height="49"
            ...
            >
              <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                <li>
                  <div role="button" className="nativelocation" tabIndex="0">
                    <span className="_1tcx6 _34oCb">
                      <span className="Home">Home</span>
                    </span>
                    <span className="location">
                      {/* 174 Classic Enclave, apposite Gayatri petrol pump, Pre
                      Conco Nagar, Precanco Colony,  */}
              ...
              <ul className="navbar-nav">
                ...
                <li className="nav-item">
                  <a className="nav-link" href="/my-account">
                    ...
                    <span className="_1qbcC">Akki</span>
                  </a>
                </li>
                <li className="nav-item">
                  <a className="nav-link" href="">
